...
* Project modification
    * Allows login by email and password
    * Adds the feature of adding, removing or editing devices
    * Adds a third type of device, air conditioning
    * Incorporates visual improvements of the buttons
    * Adds 'toast' type messages
    * Adds new info to README accordingly
    * Changes webapp example image
